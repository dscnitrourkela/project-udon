		...
		<section className='w-full bg-[#1E1E1E] pb-[24px]' id='footer'>
			<div className='w-[95%] mx-auto pt-[16px] pb-[24px] md:pb-[52px]' style={{ borderBottom: '1px solid white' }}>
				...
				<div className='flex lg:flex-row flex-col md:justify-between gap:[48px] lg:gap-[100px]'>
					<div className='mx-auto lg:mx-0 h-[115px] md:h-[174px] w-[115px] md:w-[174px] my-auto lg:pl-[24px]'>
						<img
							src='https://res.cloudinary.com/dme9vltjf/image/upload/v1697438367/Instagram_post_-_7_y5szxa.png'
							alt='logo'
						/>
					</div>
					<div className='flex md:flex-row flex-col items-center lg:items-start justify-center gap-[48px] md:gap-[98px] lg:gap-[164px] lg:pr-[54px]'>
						<div className=''>
							<Heading
								variant='h3'
							...
							<Paragraph variant='body3' className='pt-[8px] md:pt-[12px] text-white text-center md:text-start'>
								Email: <span className='text-[#FF7647]'>{footerData.contact.email}</span>
							</Paragraph>
							<div className='flex justify-center md:justify-start gap-[42px] md:gap-[26px] pt-[10px] md:pt-[16px]'>
