		...
		<section>
			<div className='container py-6 flex flex-col items-center md:pb-[30px] sm:pb-[51px]'>
				<Paragraph variant='body2' className='text-center font-semibold'>
					...
					<br />
					{aboutUsData.tag2}
					<Paragraph variant='body1' className='font-syne font-extrabold inline-block'>
			...
			<div className='justify-between px-[0px] sm:px-[77px] md:px-[115px] lg:px-[175px] grid grid-cols-1 sm:grid-cols-3 gap-3 pb-[40px] sm:pb-[130px] md:pb-[135px]'>
				{aboutUsData.lists.map((list, index) => (
					<div key={index} className='flex flex-col pb-[10px]'>
						...
						<Paragraph variant='body2' className='text-center font-bold'>
							{list.title}
						</Paragraph>
					</div>
				))}
			...
			<PersonalizedText
				className='relative pl-[20px] sm:pl-[90px] md:pl-[80px] lg:pl-[90px] xl:pl-[100px] 2xl:pl-[110px] pb-[50px] sm:pb-[32px] md:pb-[23px] lg:pb-[33px] text-[8px] sm:text-base 2xl:text-lg -z-50 text-primary-foreground font-normal'
			...
			<Paragraph
				variant='body2'
				className='text-center mx-auto px-[30px] sm:px-[135px] mt-[-60px] pb-[25px] sm:pb-[40px] md:pb-[55px] lg:pb-[80px]'>
